...
p;16;CPCharacterSet.jt;29431;@STATIC;1.0;i;9;CPArray.ji;13;CPException.ji;10;CPObject.ji;10;CPString.ji;7;CPURL.jt;29339;
objj_executeFile("CPArray.j",YES);
objj_executeFile("CPException.j",YES);
objj_executeFile("CPObject.j",YES);
objj_executeFile("CPString.j",YES);
...
p;14;CPDictionary.jt;8736;@STATIC;1.0;i;9;CPArray.ji;14;CPEnumerator.ji;13;CPException.ji;8;CPNull.ji;10;CPObject.jt;8640;
objj_executeFile("CPArray.j",YES);
...
p;9;CPArray.jt;16295;@STATIC;1.0;i;14;CPEnumerator.ji;13;CPException.ji;10;CPObject.ji;9;CPRange.ji;18;CPSortDescriptor.ji;20;_CPJavaScriptArray.jt;16162;
objj_executeFile("CPEnumerator.j",YES);
objj_executeFile("CPException.j",YES);
objj_executeFile("CPObject.j",YES);
objj_executeFile("CPRange.j",YES);
...
var _bd=objj_msgSend(_b8,"objectAtIndex:",_ba),_be=_bd&&_bd.isa?objj_msgSend(_bd,"description"):String(_bd);
_bc+="\t"+_be.split("\n").join("\n\t");
if(_ba!==_bb-1){
_bc+=", ";
}
...
}),new objj_method(sel_getUid("pathsMatchingExtensions:"),function(_bf,_c0,_c1){
with(_bf){
var _c2=0,_c3=objj_msgSend(_bf,"count"),_c4=[];
for(;_c2<_c3;++_c2){
if(_bf[_c2].isa&&objj_msgSend(_bf[_c2],"isKindOfClass:",objj_msgSend(CPString,"class"))&&objj_msgSend(_c1,"containsObject:",objj_msgSend(_bf[_c2],"pathExtension"))){
_c4.push(_bf[_c2]);
}
}
return _c4;
}
}),new objj_method(sel_getUid("copy"),function(_c5,_c6){
with(_c5){
return objj_msgSend(objj_msgSend(_c5,"class"),"arrayWithArray:",_c5);
}
})]);
class_addMethods(_5,[new objj_method(sel_getUid("alloc"),function(_c7,_c8){
with(_c7){
if(_c7===CPArray||_c7===CPMutableArray){
return objj_msgSend(_CPPlaceholderArray,"alloc");
}
return objj_msgSendSuper({receiver:_c7,super_class:objj_getMetaClass("CPArray").super_class},"alloc");
}
}),new objj_method(sel_getUid("array"),function(_c9,_ca){
with(_c9){
return objj_msgSend(objj_msgSend(_c9,"alloc"),"init");
}
}),new objj_method(sel_getUid("arrayWithArray:"),function(_cb,_cc,_cd){
with(_cb){
return objj_msgSend(objj_msgSend(_cb,"alloc"),"initWithArray:",_cd);
}
}),new objj_method(sel_getUid("arrayWithObject:"),function(_ce,_cf,_d0){
with(_ce){
return objj_msgSend(objj_msgSend(_ce,"alloc"),"initWithObjects:",_d0);
}
}),new objj_method(sel_getUid("arrayWithObjects:"),function(_d1,_d2,_d3){
with(_d1){
arguments[0]=objj_msgSend(_d1,"alloc");
arguments[1]=sel_getUid("initWithObjects:");
return objj_msgSend.apply(this,arguments);
}
}),new objj_method(sel_getUid("arrayWithObjects:count:"),function(_d4,_d5,_d6,_d7){
with(_d4){
return objj_msgSend(objj_msgSend(_d4,"alloc"),"initWithObjects:count:",_d6,_d7);
}
})]);
...
var _5=_4.isa;
class_addMethods(_4,[new objj_method(sel_getUid("initWithCoder:"),function(_d8,_d9,_da){
with(_d8){
return objj_msgSend(_da,"decodeObjectForKey:","CP.objects");
}
}),new objj_method(sel_getUid("encodeWithCoder:"),function(_db,_dc,_dd){
with(_db){
objj_msgSend(_dd,"_encodeArrayOfObjects:forKey:",_db,"CP.objects");
}
})]);
...
objj_registerClassPair(_4);
class_addMethods(_4,[new objj_method(sel_getUid("initWithArray:"),function(_de,_df,_e0){
with(_de){
_de=objj_msgSendSuper({receiver:_de,super_class:objj_getClass("_CPArrayEnumerator").super_class},"init");
if(_de){
_array=_e0;
_index=-1;
}
...
}),new objj_method(sel_getUid("nextObject"),function(_e1,_e2){
with(_e1){
...
class_addIvars(_4,[new objj_ivar("_array"),new objj_ivar("_index")]);
objj_registerClassPair(_4);
class_addMethods(_4,[new objj_method(sel_getUid("initWithArray:"),function(_e3,_e4,_e5){
with(_e3){
_e3=objj_msgSendSuper({receiver:_e3,super_class:objj_getClass("_CPReverseArrayEnumerator").super_class},"init");
if(_e3){
_array=_e5;
...
}),new objj_method(sel_getUid("nextObject"),function(_e6,_e7){
with(_e6){
if(--_index<0){
return nil;
}
...
objj_registerClassPair(_4);
class_addMethods(_5,[new objj_method(sel_getUid("alloc"),function(_e8,_e9){
with(_e8){
if(!_8){
_8=objj_msgSendSuper({receiver:_e8,super_class:objj_getMetaClass("_CPPlaceholderArray").super_class},"alloc");
}
return _8;
}
})]);
...
p;21;CPCompoundPredicate.jt;5178;@STATIC;1.0;i;9;CPArray.ji;13;CPPredicate.jt;5128;
objj_executeFile("CPArray.j",YES);
objj_executeFile("CPPredicate.j",YES);
